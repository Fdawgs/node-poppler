export class Poppler {
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfFonts(file: string, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfImages(file: string, outputPrefix: string, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfInfo(file: string, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfToCairo(file: string, outputFile?: string | undefined, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfToHtml(file: string, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfToPpm(file: string, outputPath: string, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfToPs(file: string, outputFile?: string | undefined, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfToText(file: string, outputFile?: string | undefined, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
