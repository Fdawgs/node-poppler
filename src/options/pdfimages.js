...
module.exports = {
	allFiles: { arg: "-all", type: "boolean", minVersion: undefined },
	ccittFile: { arg: "-ccitt", type: "boolean", minVersion: undefined },
	firstPageToConvert: { arg: "-f", type: "number", minVersion: undefined },
	lastPageToConvert: { arg: "-l", type: "number", minVersion: undefined },
	jbig2File: { arg: "-jbig2", type: "boolean", minVersion: undefined },
	jpeg2000File: { arg: "-jp2", type: "boolean", minVersion: undefined },
	jpegFile: { arg: "-j", type: "boolean", minVersion: undefined },
	...
	pngFile: { arg: "-png", type: "boolean", minVersion: undefined },
	printFilenames: {
		arg: "-print-filenames",
		type: "boolean",
		minVersion: "24.03.0",
