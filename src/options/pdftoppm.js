...
module.exports = {
	antialiasFonts: { arg: "-aa", type: "string", minVersion: undefined },
	antialiasVectors: {
		arg: "-aaVector",
		type: "string",
	...
	cropHeight: { arg: "-H", type: "number", minVersion: undefined },
	cropSize: { arg: "-sz", type: "number", minVersion: undefined },
	cropWidth: { arg: "-W", type: "number", minVersion: undefined },
	cropXAxis: { arg: "-x", type: "number", minVersion: undefined },
	cropYAxis: { arg: "-y", type: "number", minVersion: undefined },
	defaultCmykProfile: {
	...
	firstPageToConvert: { arg: "-f", type: "number", minVersion: undefined },
	forcePageNumber: {
		arg: "-forcenum",
		type: "boolean",
		minVersion: "0.75.0",
	},
	freetype: { arg: "-freetype", type: "string", minVersion: undefined },
	grayscaleFile: { arg: "-gray", type: "boolean", minVersion: undefined },
	hideAnnotations: {
	...
	lastPageToConvert: { arg: "-l", type: "number", minVersion: undefined },
	monochromeFile: { arg: "-mono", type: "boolean", minVersion: undefined },
	oddPagesOnly: { arg: "-o", type: "boolean", minVersion: "0.13.3" },
	overprint: { arg: "-overprint", type: "boolean", minVersion: undefined },
	...
	quiet: { arg: "-q", type: "boolean", minVersion: undefined },
	resolutionXAxis: { arg: "-rx", type: "number", minVersion: undefined },
	resolutionXYAxis: { arg: "-r", type: "number", minVersion: undefined },
	resolutionYAxis: { arg: "-ry", type: "number", minVersion: undefined },
	scaleDimensionBeforeRotation: {
		arg: "-scale-dimension-before-rotation",
		type: "boolean",
		minVersion: "0.84.0",
	},
	scalePageTo: { arg: "-scale-to", type: "number", minVersion: undefined },
	scalePageToXAxis: {
		arg: "-scale-to-x",
		type: "number",
		minVersion: undefined,
